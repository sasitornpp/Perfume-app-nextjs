...
import { setProfile } from "@/redux/user/userReducer";
...
function UserProfileForm() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const profile = await fetchProfile(formData.userId);
        ...
        >
          <Card className="w-full max-w-md text-center">
            <CardHeader>
              ...
              <CardDescription>Your profile has been successfully updated.</CardDescription>
            </CardHeader>
          </Card>
        </motion.div>
      ) : (
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>Let others know who you are</CardDescription>
              <div className="mt-4">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.div 
                  ...
                  initial={{ y: 20, opacity: 0 }}
                  animate={activeField === "username" ? "active" : "inactive"}
                ...
                <motion.div 
                  ...
                  animate={
                    activeField === "bio" 
                      ? { ...fieldVariants.active, y: 0, opacity: 1 }
                      : { ...fieldVariants.inactive, y: 0, opacity: 1 }
                  }
            ...
            <CardFooter className="flex flex-col gap-4 sm:flex-row">
              <Link href="/home/search" className="w-full sm:w-auto">
                <Button
                  type="button"
                  variant="outline"
