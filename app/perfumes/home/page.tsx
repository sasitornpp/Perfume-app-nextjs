        ...
        <div className="bg-gradient-to-br from-primary/90 to-primary/50 rounded-xl overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-6 p-8 md:p-12 relative z-20">
            ...
            >
              ...
              >
                <Heart className="inline-block w-3 h-3 mr-1" /> Personalized Fragrance
              </motion.span>
              <motion.h1
                variants={itemVariants}
                className="text-4xl md:text-5xl font-bold mb-4 leading-tight"
              >
                Discover Your <span className="underline decoration-accent underline-offset-4">Perfect</span> Scent
              </motion.h1>
              <motion.p
                variants={itemVariants}
                className="text-primary-foreground/90 mb-8 text-lg"
              >
                Explore our curated collection of premium fragrances tailored to your unique preferences and personality.
              </motion.p>
              {!profile?.suggestions_perfumes ? (
                <motion.div
                  variants={itemVariants}
                ...
                >
                  ...
                  >
                    <Sparkles className="mr-2 h-4 w-4" /> Find Your Signature Scent
                ...
                >
                  <Button
                    ...
                    className="bg-background text-primary hover:bg-secondary hover:text-secondary-foreground hover:shadow-lg transition-all w-full sm:w-auto"
                  >
                    <Heart className="mr-2 h-4 w-4" /> See Your Recommendations
                    <ChevronRight className="ml-2 h-4 w-4" />
                  </Button>
                </motion.div>
              )}
              ...
              <Card className="border hover:border-primary/20 transition-all cursor-pointer bg-card h-full rounded-lg shadow-sm hover:shadow-md">
                <CardContent className="flex flex-col items-center p-6">
                  <motion.div
                    ...
                    animate={{
                      y: hoveredBrandIndex === index ? [0, -5, 0] : 0,
                    }}
                    transition={{
                      duration: 1.5,
                      repeat: hoveredBrandIndex === index ? Infinity : 0,
                      repeatType: "reverse",
                    }}
                  >
                    <Image
                  ...
                  <motion.span 
                    ...
                    animate={{
                      color: hoveredBrandIndex === index ? "var(--primary)" : "var(--foreground)"
                    }}
                  >
                    {brand.brand}
                  </motion.span>
